        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!(i < result.data.length)) return [3 /*break*/, 8];
                    if (!(result.data[i].name.substring(0, 9) === 'releases/')) return [3 /*break*/, 7];
                    releaseFlag = true;
                ...
                case 9:
                    ...
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/, Promise.resolve(validationResultRepo)];
            }
        });
    });
}
