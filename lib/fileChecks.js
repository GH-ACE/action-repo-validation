...
exports.releasesfaildeModulesCheck = exports.faildeModulesCheck = exports.codeOwnerCheck = exports.readmeChecks = void 0;
...
function faildeModulesCheck(repository, validationResultRepo, ownername, secret_token, octokit) {
    return __awaiter(this, void 0, void 0, function () {
        var result, includes_failde_modules, err_3, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, octokit.request('GET /repos/{owner}/{repo}/contents/failde_modules', {
                            repo: repository,
                            owner: ownername,
                            headers: {
                                Authorization: 'Bearer ' + secret_token
                ...
                case 3:
                    includes_failde_modules = _a.sent();
...
exports.faildeModulesCheck = faildeModulesCheck;
function releasesfaildeModulesCheck(repository, validationResultRepo, ownername, secret_token, octokit) {
    return __awaiter(this, void 0, void 0, function () {
        var result, release_flag, i, branchname, branch, flag, j, err_5, err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
                ...
                case 5:
                    ...
                    return [2 /*return*/, Promise.resolve(validationResultRepo)];
                case 6:
                    i++;
                    return [3 /*break*/, 2];
                case 7:
...
exports.releasesfaildeModulesCheck = releasesfaildeModulesCheck;
