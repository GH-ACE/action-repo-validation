...
exports.standardLabelsCheck = void 0;
function standardLabelsCheck(repository, validationResultRepo, ownerName, secret_token, octokit) {
    return __awaiter(this, void 0, void 0, function () {
        var result, labelArray, existingLabels, absentLabels, i, standardLabelsArray, i, label, errorOutput, i, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    validationResultRepo['standardLabels'] = err_1.status;
                    return [3 /*break*/, 3];
...
exports.standardLabelsCheck = standardLabelsCheck;
